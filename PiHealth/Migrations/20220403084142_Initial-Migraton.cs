        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpecializationId = table.Column<long>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProcedureMasterId = table.Column<long>(nullable: true),
                    AppointmentId = table.Column<long>(nullable: false),
                    Compliants = table.Column<string>(nullable: true),
                    Examination = table.Column<string>(nullable: true),
                    PastHistory = table.Column<string>(nullable: true),
                    InvestigationResults = table.Column<string>(nullable: true),
                    Impression = table.Column<string>(nullable: true),
                    Advice = table.Column<string>(nullable: true),
                    Plan = table.Column<string>(nullable: true),
                    ReferredDoctor = table.Column<string>(nullable: true),
                    IsfollowUpNeed = table.Column<bool>(nullable: false),
                    FollowUp = table.Column<DateTime>(nullable: true),
                    IsDeleted = table.Column<bool>(nullable: false),
                    CreatedDate = table.Column<DateTime>(nullable: false),
                    ModifiedDate = table.Column<DateTime>(nullable: true),
                    CreatedBy = table.Column<long>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModifiedBy = table.Column<long>(nullable: true),
                    IsDeleted = table.Column<bool>(nullable: false),
                    Sos = table.Column<bool>(nullable: false),
